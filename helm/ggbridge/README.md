...
| proxy.tunnels.web.gateway.gateway.tls.enabled | bool | `true` | Enable TLS traffic |
...
| proxy.tunnels.web.ingress.listeners | list | `[]` | Specify web tunnel listeners # e.g: # listeners: #    - hostname: api.internal.com #      backend: api.gitguardian.com #      tls: #        secretName: "internal-crt" #    - hostname: hook.internal.com #      backend: hook.gitguardian.com #      tls: #        secretName: "internal-crt" |
| proxy.tunnels.web.ingress.tls.enabled | bool | `true` | Enable TLS traffic |
...
| shell.image.digest | string | `""` | Image digest in the way sha256:aa.... |
| shell.image.pullPolicy | string | `"IfNotPresent"` | Image pull policy |
| shell.image.pullSecrets | list | `[]` | Image pull secrets |
| shell.image.registry | string | `"ghcr.io"` | Image registry |
| shell.image.repository | string | `"gitguardian/ggbridge"` | Image repository |
| shell.image.tag | string | `""` | Image tag |
